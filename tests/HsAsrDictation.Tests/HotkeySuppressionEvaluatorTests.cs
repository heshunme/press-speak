...
public sealed class HotkeySuppressionEvaluatorTests
{
    ...
    [Fact]
    public void ShouldSuppress_WithNormalizedKeys_ReturnsTrue_ForSingleKeyGesture()
    {
        ...
        var result = HotkeySuppressionEvaluator.ShouldSuppress(
            normalizedGestureKeys,
            new HashSet<HotkeyPhysicalKey> { Oem3Key },
            CreateKeyEvent(Oem3Key, isKeyDown: true),
            wasGestureActive: false,
            isGestureActive: true);
    ...
    [Fact]
    public void ShouldSuppress_WithNormalizedKeys_ReturnsTrue_ForPrimaryKeyUp_AfterChordWasActive()
    {
        var normalizedGestureKeys = new HotkeyGesture
        {
            Keys = [LeftAltKey, Oem3Key]
        ...
        var result = HotkeySuppressionEvaluator.ShouldSuppress(
            normalizedGestureKeys,
            new HashSet<HotkeyPhysicalKey> { LeftAltKey },
            CreateKeyEvent(Oem3Key, isKeyDown: false),
            wasGestureActive: true,
            isGestureActive: false);
    ...
    [Fact]
    public void ShouldSuppress_WithNormalizedKeys_ReturnsFalse_ForModifierOnlyPartOfChord()
    {
        var normalizedGestureKeys = new HotkeyGesture
        {
            Keys = [LeftAltKey, Oem3Key]
    ...
    [Fact]
    public void ShouldSuppress_WithNormalizedKeys_ReturnsFalse_ForUnrelatedKey()
    {
        var normalizedGestureKeys = new HotkeyGesture
        {
            Keys = [LeftAltKey, Oem3Key]
        ...
        var result = HotkeySuppressionEvaluator.ShouldSuppress(
            normalizedGestureKeys,
            new HashSet<HotkeyPhysicalKey> { LeftAltKey, KKey },
            CreateKeyEvent(KKey, isKeyDown: true),
            wasGestureActive: false,
            isGestureActive: false);
